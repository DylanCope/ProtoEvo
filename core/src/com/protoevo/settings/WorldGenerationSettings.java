...
public class WorldGenerationSettings {
    ...
    public static final int numRingClusters = 8;
    public static final int numPopulationStartClusters = 3;
    public static final float rockClusterRadius = .65f;
    ...
    public static final float maxRockSize = SimulationSettings.maxParticleRadius * 2f;
    ...
    public static final float minRockOpeningSize = maxRockSize / 2f;
