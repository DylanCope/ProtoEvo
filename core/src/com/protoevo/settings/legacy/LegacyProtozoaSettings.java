...
public class LegacyProtozoaSettings {
    ...
    public static float engulfEatingRateMultiplier = 3f;
    ...
    public static final float protozoaLightRange = LegacySimulationSettings.maxParticleRadius * 5f;
