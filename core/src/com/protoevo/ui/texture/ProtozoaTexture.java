...
public class ProtozoaTexture extends Texture {
    ...
    private static BufferedImage getNodeEmpty() {
        if (nodeEmpty == null) {
            nodeEmpty = ImageUtils.loadImage("entity/surface_node_empty.png");
        }
        return nodeEmpty;
    }
...
//            g2d.fillOval(
//                    (int) (centreX + r * Math.cos(t)) - dotR,
//                    (int) (centreX + r * Math.sin(t)) - dotR,
//                    2*dotR, 2*dotR);
//            g2d.setColor(Color.BLUE);
//            g2d.fillOval(
//                    (int) (centreX + r * Math.cos(t - deltaT)) - dotR,
//                    (int) (centreX + r * Math.sin(t - deltaT)) - dotR,
//                    2*dotR, 2*dotR);
        }
